    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="sub-hero bg-4 rn-page-title-area pt--120 bg_image" style={{ backgroundImage: `url(/assets/images/hero-images/subpage-02.jpg)` }} data-black-overlay="3">
