...
class BlogDetail extends Component {
  ...
  getBlog(uid) {
    fetch(
      `https://cdn.contentstack.io/v3/content_types/blog_post/entries/${uid}?&environment=development&locale=en-us`,
      {
        method: "get",
        mode: "cors",
        headers: {
      ...
      <React.Fragment>
        <PageHelmet
          ...
          ogImage={
            blog.og_image
              ? blog.og_image.url
              : "https://images.contentstack.io/v3/assets/bltb9eff0ec0532965e/blta5fb5186db0221ca/5eecbe71464b61607c65f1ab/Matts_blog_-_pic.jpg"
          }
        />
        <Header
          headertransparent="header--black"
          colorblack="color--white"
          logoname="logo.png"
        />
        {/* Start Breadcrump Area */}
        <div
          className="sub-hero rn-page-title-area pt--120 bg_image"
          style={{ backgroundImage: `url(${blog.hero_image.url})` }}
