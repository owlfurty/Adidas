...
class CompIndivu extends Component{
    ...
    getBoard = () => {
        fetch('https://cdn.contentstack.io/v3/content_types/company_and_indivuduals/entries?environment=development&locale=en-us', {
            method:'get',
            mode:'cors',
            headers:{
